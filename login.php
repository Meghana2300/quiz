                    ...
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <div class="alert alert-danger" id="failure"style="margin-top: 10px;display:none">
                                <strong>Doesnot Match!</strong> Incorrect Username Or Password.
                                </div> 
                        </form>
                    </div>
                </div>
...
$count=0;
$res=mysqli_query($link,"select * from registeration where username='$_POST[username]'&& password='$_POST[password]'");
